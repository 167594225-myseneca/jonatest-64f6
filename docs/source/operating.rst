[jonatest-64f6] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [jonatest-64f6] container is NOT running**.

.. tip::
   You must have your [jonatest-64f6] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39739  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='167594225-myseneca'  \-\-env DOCKERUSERNAME='jona.lyn.learning@gmail.com'  \-\-env MQTTUSERNAME='jonalyn'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   jona.lyn.learning@gmail.com/jonatest-64f6-amd64 (https://hub.docker.com/r/jona.lyn.learning@gmail.com/jonatest-64f6-amd64)
...
.. code-block::
   ...
   docker run -d -p 43915:43915 -p 41165:41165 -p 49569:49569 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=jonatest-64f6 \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-jonatest-64f6 \
          --env GITUSERNAME=167594225-myseneca \
          --env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=43915 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=41165  \
          --env SOLUTIONVIPERVIZPORT=49569 \
          ...
          jona.lyn.learning@gmail.com/jonatest-64f6-amd64
...
[jonatest-64f6] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/167594225-myseneca/cyt160-raspberrypi/tree/main/tml-airflow/dags/tml-solutions/jonatest-64f6
...
.. important::
   https://jonatest-64f6.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-jonatest-64f6
...
.. important::
   VIPERHOST_PRODUCE=10.1.0.4, VIPERPORT_PRODUCE=43915, VIPERHOST_PREPOCESS=10.1.0.4, VIPERPORT_PREPROCESS=32849, VIPERHOST_PREPOCESS2=10.1.0.4, VIPERPORT_PREPROCESS2=35319, VIPERHOST_PREPOCESS_PGPT=10.1.0.4, VIPERPORT_PREPROCESS_PGPT=40635, VIPERHOST_ML=10.1.0.4, VIPERPORT_ML=39253, VIPERHOST_PREDCT=10.1.0.4, VIPERPORT_PREDICT=34459, HPDEHOST=10.1.0.4, HPDEPORT=46421, HPDEHOST_PREDICT=10.1.0.4, HPDEPORT_PREDICT=34561

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6257-jonatest-64f6,solution_preprocessing_ai_mqtt_dag-jonatest-64f6, python-preprocess-4256-jonatest-64f6,solution_preprocessing_ai_mqtt_dag-jonatest-64f6, python-ai-9761-jonatest-64f6,solution_preprocessing_ai_mqtt_dag-jonatest-64f6, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
